        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ElevGainM = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    IsPotentialDuplicate = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "text", nullable: false),
                    TileProvider = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, defaultValue: "osm"),
                    ImportHelpDismissed = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HrBpm = table.Column<short>(type: "smallint", nullable: true),
                    CadenceRpm = table.Column<short>(type: "smallint", nullable: true),
                    PowerW = table.Column<short>(type: "smallint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_route_points", x => x.Id);
                    table.ForeignKey(
                        name: "FK_route_points_routes_RouteId",
                        column: x => x.RouteId,
